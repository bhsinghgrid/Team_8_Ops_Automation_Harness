...
class OCSCatalogClient:
    ...
    def __init__(
        self,
        base_url: str = "http://127.0.0.1:8534",
        tenant: str = "ocs_example",
        timeout: float = 10.0,
    ):
    ...
    def get_product(self, product_id: str) -> Optional[Dict[str, Any]]:
        response = self._request("GET", f"/search-api/v1/doc/{self.tenant}/{product_id}")
    ...
    def add_product(self, product: Dict[str, Any]) -> bool:
        ...
        response = self._request(
            "PUT",
            f"/indexer-api/v1/update/{self.tenant}",
            params={"langCode": "en"},
            json=[document],
        )
    ...
    def update_product(self, product_id: str, fields: Dict[str, Any]) -> bool:
        ...
        response = self._request("PATCH", f"/indexer-api/v1/update/{self.tenant}", json=[document])
        return self._success(response, {200, 201, 204})
    ...
    def flush_config(self) -> bool:
        response = self._request("GET", f"/search-api/v1/flushConfig/{self.tenant}")
